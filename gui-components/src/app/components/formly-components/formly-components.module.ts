...
import {DatepickerFormlyComponent} from "src/app/components/formly-components/datepicker-formly/datepicker-formly.component";
import {
  ...
  imports: [
    ...
    FormlyModule.forRoot({
      ...
      types: [
        ...
        {name: 'datepicker', component: DatepickerFormlyComponent}
      ],
    }),
    NzInputNumberModule,
    DragDropModule,
