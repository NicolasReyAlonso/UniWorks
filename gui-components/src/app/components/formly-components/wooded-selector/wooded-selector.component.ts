...
import {BACKEND_SERVICE, BackendService, BackendServiceInterface} from 'ngt-gui/core';
...
export class WoodedSelectorComponent extends FieldType implements OnInit {
  ...
  constructor(@Inject (BACKEND_SERVICE) private backendService: BackendServiceInterface) {
    super();
  }
