...
import {BackendServiceInterface, BACKEND_SERVICE, MessageLogServiceInterface, MESSAGE_LOG_SERVICE} from 'ngt-gui/core';

import {NotificationServiceInterface, NOTIFICATION_SERVICE, TypeNotificationEnum} from 'ngt-gui/core';
...
export class AclModalComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(NOTIFICATION_SERVICE) private notificationServices: NotificationServiceInterface,
