...
import { NotificationServiceInterface } from 'ngt-gui/core';
...
import { FILES_SERVICE_TOKEN } from 'ngt-gui/core';
...
export class NextgendemMissingEditorComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    @Inject(MESSAGE_LOG_SERVICE) private readonly messageLogSerivce: MessageLogServiceInterface,
  ) {
  }
