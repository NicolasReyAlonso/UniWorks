import {AfterViewInit, Component, HostListener, Input, OnDestroy, ViewEncapsulation} from '@angular/core';
...
} from "../../dynamics/dynamic-input-modal/dynamic-input-modal.component";
...
export class NextgendemMsaBrowserComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private readonly msg: MessageLogService,
