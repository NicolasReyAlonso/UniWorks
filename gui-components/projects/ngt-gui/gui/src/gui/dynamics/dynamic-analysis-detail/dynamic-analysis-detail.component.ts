import {AfterViewInit, Component, EventEmitter, Inject, OnInit, Output, TemplateRef, ViewChild, Input} from '@angular/core';
import {BackendService, FILES_SERVICE_TOKEN, FilesServiceInterface, GlobalServiceInterface} from 'ngt-gui/core';
...
} from '../../data/annotations/annotations-form/annotations-form.component';
import {FilesService} from 'ngt-gui/core';
...
import { AUTH_SERVICE_TOKEN, 
  AuthServiceInterface, GLOBAL_SERVICE, MESSAGE_LOG_SERVICE, MessageLogServiceInterface, NOTIFICATION_SERVICE, NotificationServiceInterface } from 'ngt-gui/core';
